 ...
 * uncluttered button. It is hidden on the pricing page, which is where it
 * leads — the calculator is already on screen there.
 */
const StickyActions = () => {
  const { pathname } = useLocation();

  if (pathname.replace(/\/+$/, "") === "/pricing") return null;
